...
Money::Money(double s1, double s2) : Pair(s1, s2)
{
	g1000 = 0;
	g500 = 0;
	g200 = 0;
...
{
	return Money(a.GetG1000() * 1000. + a.GetG500() * 500. + a.GetG200() * 200. + a.GetG100() * 100. + a.GetG50() * 50. +
		a.GetG20() * 20. + a.GetG10() * 10. + a.GetG5() * 5. + a.GetG2() * 2. + a.GetG1() * 1. + a.GetC50() * 0.50 + a.GetC10() * 0.1,
		b.GetG1000() * 1000. + b.GetG500() * 500. + b.GetG200() * 200. + b.GetG100() * 100. + b.GetG50() * 50. +
		b.GetG20() * 20. + b.GetG10() * 10. + b.GetG5() * 5. + b.GetG2() * 2. + b.GetG1() * 1. + b.GetC50() * 0.50 + b.GetC10() * 0.1);
}

double operator / (Money& a, Money& b)
{
	if (a > b)
		return a.GetFirst() / b.GetSecond();
	else
		if (a < b)
			return  b.GetSecond() / a.GetFirst();
}